<?php
    ...
    falgun_add_body_class('contact');
    osc_current_web_theme_path('header.php');
?>
<div class="form-row-header">
  <h1 id="form-row-h1"><?php _e('Send to a friend', 'falgun'); ?></h1>
</div>
    ...
    <div class="col-md-6 col-md-offset-3 item-post" id="form-login">
      <div class="form-login">
        ...
        <form name="sendfriend" action="<?php echo osc_base_url(true); ?>" method="post" >
            ...
            <div class="control-group">
                <label class="control-label" for="yourEmail"><?php _e("Your e-mail",'falgun'); ?></label>
                <div class="controls ">
            ...
            <?php } ?>
            <div class="control-group">
                <label class="control-label" for="friendName"><?php _e("Your friend's name",'falgun'); ?></label>
                <div class="controls">
                    <?php SendFriendForm::friend_name(); ?>
                </div>
            </div>
            <div class="control-group">
                <label for="friendEmail"><?php _e("Your friend's e-mail address", 'falgun'); ?></label> </label>
                <div class="controls">
            ...
            <div class="control-group">
                <label class="control-label" for="subject">
                    <?php _e('Subject (optional)', 'falgun'); ?>
                </label>
                <div class="controls">
