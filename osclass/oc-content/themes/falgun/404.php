...
<?php
    ...
    falgun_add_body_class('error not-found');
    osc_current_web_theme_path('header.php') ;
?>
<div class="flashmessage-404">
    <h1><?php _e("Sorry but I can't find the page you're looking for", 'falgun') ; ?></h1>
    <p><?php _e("Let us help you, we have got a few tips for you to find it.", 'falgun') ; ?></p><hr>
    <ul>
        <li>
            <?php _e("<strong>Search</strong> for it:", 'falgun') ; ?>
            <form action="<?php echo osc_base_url(true) ; ?>" method="get" class="search">
                ...
                <fieldset class="main row">
                    ...
                    <div class="col-sm-6">
                       <button type="submit" class="btn btn-md"><?php _e('Search', 'falgun') ; ?></button>
                    </div>   
                </fieldset>
            </form>
        </li>
        <li><?php _e("<strong>Look</strong> for it in the most popular categories.", 'falgun') ; ?>
