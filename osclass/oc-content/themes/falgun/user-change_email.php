<?php
    ...
    function custom_meta_title($data){
        return __('Change e-mail', 'falgun');;
    }
        ...
        <div class="form-login col-md-offset-2 col-md-offset-right-2 item-post">
            ...
            <form id="change-email" action="<?php echo osc_base_url(true); ?>" method="post">
                <div class="form-row-header">    
                    <h1 id="form-row-h1"><?php _e('Change E-Mail', 'falgun'); ?></h1>
                </div> 
                    <input type="hidden" name="page" value="user" />
                    <input type="hidden" name="action" value="change_Email_post" />
                    <div class="control-group">
                        <label for="email"><?php _e('Current e-mail', 'falgun'); ?></label>
                        <div class="controls">
                            <?php echo osc_logged_user_email(); ?>
                        </div>
                    </div>
                    <div class="control-group">
                        <label class="control-label" for="new_email"><?php _e('New E-Mail', 'falgun'); ?> *</label>
                        <div class="controls">
